        ...
        <div className="max-w-4xl mx-auto space-y-8">
          ...
          <div className="animate-fade-in">
            ...
            >
              ...
              Powered by Jharkhand Higher Education Department
            </Badge>
          </div>
          ...
          <div className="space-y-4 animate-slide-up" style={{ animationDelay: '0.2s' }}>
            ...
            <p className="text-xl md:text-2xl text-white/90 leading-relaxed max-w-3xl mx-auto">
              ...
              Protect academic integrity with government-grade security.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center animate-scale-in" style={{ animationDelay: '0.4s' }}>
            <Link to="/verify">
              <Button variant="hero" size="lg" className="group px-8 py-6 text-lg font-semibold">
          ...
          <div className="flex flex-wrap justify-center gap-8 pt-8 animate-fade-in" style={{ animationDelay: '0.6s' }}>
            <div className="flex items-center space-x-2 text-white/80">
              ...
              <span className="text-sm font-medium">Government Authorized</span>
            </div>
            <div className="flex items-center space-x-2 text-white/80">
              <CheckCircle className="h-5 w-5 text-success" />
